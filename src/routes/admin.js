...
router.get('/analytics', async (req, res) => {
  try {
    ...
    const [analytics, retention, channelCohorts, calendarConnection, acquisition] = await Promise.all([
    ...
    return res.json({
      ...analytics, retention, channelCohorts, calendarConnection, acquisition,
    });
  } catch (err) {
