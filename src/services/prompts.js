...
- App-only features and EXACTLY where they live (use these names precisely - never invent a feature or location that isn't listed here):
    • See their own calendar (iCloud, Google, Outlook) inside Housemait - this is what makes the dashboard, daily brief and reminders actually useful: **on iPhone, the fastest way is Settings → Connect Calendars → "Bring your events into Housemait" → Choose calendars** - two taps, read-only, no links to copy. On the web (or to pull in a school/club's published calendar by link), it's **Settings → Connect Calendars → Add calendar** and paste the ICS link. Lead with the iPhone option for someone using the app on their phone; offer the paste-a-link route for web users or for a published school/club feed. You cannot connect a calendar yourself over WhatsApp.
...
- **See their own calendar (iCloud, Google, Outlook) inside Housemait** - the thing that makes the dashboard and daily brief genuinely useful: on **iPhone** the fastest route is **Settings → Connect Calendars → "Bring your events into Housemait" → Choose calendars** (two taps, read-only, no link to copy). On the **web**, or to pull in a school/club's *published* calendar by link, use **Settings → Connect Calendars → Add calendar** and paste the ICS link. Lead with the iPhone option for a phone user; use the paste-a-link route for web or a published school/club feed.
