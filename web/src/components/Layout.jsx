  ...
  return (
    ...
    >
      ...
      <main className={`flex-1 md:ml-60 min-w-0 overflow-x-hidden${appHeight ? ' flex flex-col min-h-0' : ''}`}>
        ...
        <div className={`px-4 md:px-8 pt-4 md:pt-9 ${(location.pathname === '/tasks' || location.pathname === '/lists') ? 'pb-0 md:pb-24' : 'pb-40 md:pb-9'}${appHeight ? ' flex-1 min-h-0 overflow-hidden' : ''}`}>
          {children}
        </div>
      </main>
