/**
 * The Google / Apple buttons for the existing signup + login pages.
 *
 * All the behaviour moved to hooks/useSocialAuth — onboarding v4 needs the same
 * flows behind its own styling, and two copies of Google's OAuth handling would
 * inevitably drift. This file is now only markup, and deliberately keeps the
 * exact classes it always had so the live pages are untouched.
 */
