...
// Shared by Settings -> Connect Calendars (the add-calendar form) and the
// onboarding calendar step. `link` deep-links as close to the page holding the
// address as each provider allows - Outlook lands EXACTLY on the publish page;
// Google can only deep-link to settings (the per-calendar page needs an id we
// can't know).
