    ...
    >
      <div className="my-auto w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-bark" style={{ fontFamily: "'Kalice', serif", fontWeight: 400, fontSize: 42, lineHeight: 1.1, letterSpacing: '-0.015em' }}>Welcome <em style={{ fontStyle: 'italic', color: '#6B2FB8' }}>back.</em></h1>
        </div>
