 ...
 *
 * Built behind /signup-next during construction; the final phase mounts it at
 * /signup itself. Visual language reuses the existing concierge stage (gradient
 * + ambient blobs + glass card) in our plum tokens. British English, no em
 * dashes, prefers-reduced-motion honoured.
 */
...
function StepPlaceholder({ stepKey, ctx }) {
  ...
  return (
    <div className="text-left">
      <h1 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 40, fontWeight: 400, lineHeight: 1.05, color: 'var(--color-charcoal)', margin: '8px 0 8px' }}>
        {stepKey}
      </h1>
