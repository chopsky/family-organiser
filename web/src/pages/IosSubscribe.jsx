      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1
            ...
            style={{ fontFamily: '"Circular Std", Georgia, serif', fontWeight: 600 }}
          >
            {copy.headline}
          </h1>
  ...
  return (
    ...
    >
      ...
      <h2
        ...
        style={{ fontFamily: '"Circular Std", Georgia, serif', fontWeight: 600, letterSpacing: '-0.02em' }}
      >
        {subscriptionTitle}
      </h2>
      ...
      <div className="mb-3">
        <div className="flex items-baseline gap-2">
          <span
            ...
            style={{ fontFamily: '"Circular Std", Georgia, serif' }}
          >
            {priceString || '—'}
          </span>
