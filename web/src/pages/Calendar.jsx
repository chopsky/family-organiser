  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2.5 flex-wrap">
        <h1 className="flex items-center gap-2.5 flex-1 min-w-0" style={{ fontFamily: '"Gramatika", Georgia, "Times New Roman", serif', fontSize: '36px', fontWeight: 400, lineHeight: 1 }}>
          <div
            className="hidden"
            style={{
              width: '42px',
