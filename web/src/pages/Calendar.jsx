  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2.5 flex-wrap">
        <h1 className="flex items-center gap-2.5 flex-1 min-w-0 text-[38px] md:text-[40px]" style={{ fontFamily: '"Instrument Serif", "Times New Roman", serif', fontWeight: 400, lineHeight: 1 }}>
          <div
            className="hidden"
            style={{
              width: '42px',
