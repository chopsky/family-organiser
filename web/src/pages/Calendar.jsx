  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-2.5 flex-wrap">
        <h1 className="flex items-center gap-2.5 flex-1 min-w-0" style={{ fontFamily: '"Circular Std", Georgia, "Times New Roman", serif', fontSize: '36px', fontWeight: 400, lineHeight: 1 }}>
          <div
            className="hidden"
            style={{
              width: '42px',
      ...
      {viewMode === 'week' && (
        <div
          ...
          className="border border-light-grey rounded-2xl overflow-hidden bg-white flex flex-col max-h-[calc(100dvh_-_280px)] md:max-h-[calc(100dvh_-_190px)]"
        >
          {/* Headers */}
