...
function AuthStack({ onPick }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
      <button type="button" onClick={() => onPick('google')} style={{ ...base, background: T.purple, color: '#fff', border: 0 }}>
      ...
      <button type="button" onClick={() => onPick('apple')} style={{ ...base, background: T.surface, color: T.ink, border: `1.5px solid ${T.line2}` }}>
...
export function SignUpScreen({ d, onBack, onPick }) {
...
export function LoginScreen({ onBack, onPick, onCreate }) {
  return (
    <div
      className="ob-v4"
      style={{
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ marginTop: 24 }}><AuthStack onPick={onPick} /></div>
...
export function DoneScreen({ d, onEnter, reduced }) {
