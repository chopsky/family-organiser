...
const STORY_CHAPTERS = [
  { h: ['Always know', 'who’s where, when'], p: 'School runs, clubs, birthdays and appointments, colour-coded by person.' },
  { h: ['Help kids build', 'healthy habits'], p: 'Routines and chores with stars to earn and treats to spend. Beds get made, teeth get brushed, and nobody nags.' },
  { h: ['The week’s meals', 'planned in seconds'], p: 'Plan the week from your family recipe box, and every ingredient lands on the shopping list by itself.' },
  ...
  { h: ['Do it all easily', 'in WhatsApp'], p: 'Message Housemait like a friend. It adds the event, updates the list and answers back in seconds.' },
]
...
export default function LandingPage() {
  ...
  return (
    <div className="lv">
      ...
      {/* ── Watch it happen: the before/after transformation. One messy
            school email in, a sorted week out - demonstrating the magic
            instead of claiming it. ── */}
      <section id="magic" className="lv-transform">
        <div className="lv-touch-head" data-lv-reveal="0">
          <h2 className="lv-h2">Watch it happen.</h2>
          <p className="lv-sub">One school email in. A sorted week out. Housemait reads the letter and puts every date where the whole family can see it.</p>
        </div>
        <div className="lv-transform-grid">
          <div className="lv-letter" data-lv-reveal="0">
            <div className="lv-letter-head">
              <div className="lv-letter-from">St Mary&rsquo;s Primary School</div>
              <div className="lv-letter-subj">Autumn Term Newsletter — please read!</div>
            </div>
            <p>Dear Parents,</p>
            <p>A few dates for your diary. Our <mark>trip to the Science Museum is on Tuesday 22 September</mark> — packed lunches please. <mark>Parents&rsquo; evening runs Thursday 8 October, 4:30–7pm</mark>, bookings open Monday.</p>
            <p>A reminder that <mark>PE kits are needed every Wednesday</mark> this term, and school closes for <mark>half term from 26–30 October</mark>.</p>
            <p>Finally, <mark>World Book Day costumes on Friday 6 November</mark> — as ever, no pressure, a book under the arm is plenty!</p>
          </div>
          <div className="lv-transform-arrow" aria-hidden="true">
          ...
          <div className="lv-extracted" data-lv-reveal="1">
            <div className="lv-chip">5 dates added to the calendar ✓</div>
            <div className="lv-row"><span className="k">🚌 Science Museum trip</span><span className="v">Tue 22 Sept</span></div>
            <div className="lv-row"><span className="k">🗓 Parents&rsquo; evening</span><span className="v">Thu 8 Oct · 4:30pm</span></div>
            <div className="lv-row"><span className="k">👟 PE kit</span><span className="v">Every Wed</span></div>
            <div className="lv-row"><span className="k">🏖 Half term</span><span className="v">26–30 Oct</span></div>
            <div className="lv-row"><span className="k">📚 World Book Day</span><span className="v">Fri 6 Nov</span></div>
            <div className="lv-transform-note">Reminders included — the costume ping lands the night before, not at 8:04am.</div>
          </div>
        </div>
      </section>

      {/* ── Every way in: the capture grid. Breadth made countable. ── */}
      <section className="lv-ways">
        <div className="lv-touch-head" data-lv-reveal="0">
          <h2 className="lv-h2">Text it. Snap it. Say it. Forward it.</h2>
          <p className="lv-sub">However the chaos arrives, there&rsquo;s a one-second way to hand it to Housemait.</p>
        </div>
        <div className="lv-ways-grid">
          <div className="lv-way" data-lv-reveal="0">
            <span className="lv-way-ic">💬</span>
            <h4>Text it</h4>
            <p>&ldquo;Swimming Tuesday at 4, and we need sun cream&rdquo; — straight from WhatsApp or the app.</p>
          </div>
          <div className="lv-way" data-lv-reveal="1">
            <span className="lv-way-ic">📸</span>
            <h4>Snap it</h4>
            <p>The letter on the fridge, the flyer in the book bag, the receipt — a photo is enough.</p>
          </div>
          <div className="lv-way" data-lv-reveal="2">
            <span className="lv-way-ic">🎙️</span>
            <h4>Say it</h4>
            <p>Voice notes on the school run get transcribed and sorted before you&rsquo;re home.</p>
          </div>
          <div className="lv-way" data-lv-reveal="0">
            <span className="lv-way-ic">✉️</span>
            <h4>Forward it</h4>
            <p>Your house gets its own email address — forward the newsletter and the dates file themselves.</p>
          </div>
          <div className="lv-way" data-lv-reveal="1">
            <span className="lv-way-ic">🗣️</span>
            <h4>Ask Siri</h4>
            <p>&ldquo;Hey Siri, add milk to Housemait&rdquo; — on the list before the fridge door shuts.</p>
          </div>
          <div className="lv-way" data-lv-reveal="2">
            <span className="lv-way-ic">📄</span>
            <h4>Send the PDF</h4>
            <p>Fixture lists, term calendars, club letters — attachments get read like everything else.</p>
          </div>
        </div>
      </section>
