  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <svg className="h-5 w-5 text-plum" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="9" cy="21" r="1" /><circle cx="20" cy="21" r="1" /><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6" />
          </svg>
        </div>
        <h1
          className="text-[36px] font-normal leading-none text-bark"
          style={{ fontFamily: '"Circular Std", Georgia, "Times New Roman", serif' }}
        >
          Shopping
        </h1>
