  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <div style={{ fontSize: 16, fontWeight: 600, fontFamily: 'var(--font-display, "Circular Std", Georgia, serif)', color: 'var(--charcoal, #2D2A33)', letterSpacing: '-0.02em' }}>
            {displayName}
          </div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <h1
          ...
          style={{
            ...
            fontWeight: 400,
            lineHeight: 1,
            fontFamily: '"Circular Std", Georgia, "Times New Roman", serif',
            ...
            <div className="flex items-center justify-between mb-1">
              <h2
                style={{
                  fontSize: 18,
                  fontWeight: 600,
                  fontFamily: 'var(--font-display, "Circular Std", Georgia, serif)',
                  color: 'var(--charcoal, #2D2A33)',
                }}
              >
