      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1
            ...
            style={{ fontFamily: '"Kalice", Georgia, serif', fontWeight: 400 }}
          >
            {copy.headline}
          </h1>
    ...
    >
      ...
      <div className="mb-5">
        <div className="flex items-baseline gap-2">
          <span className="text-charcoal leading-none" style={{ fontFamily: '"Kalice", Georgia, serif', fontWeight: 400, fontSize: 46 }}>
            {p.priceDisplay}
          </span>
